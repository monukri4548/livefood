...
function App() {
  ...
  return (
    <div className="flex">
      <Navbar />
      <div className="w-full absolute mt-20 flex items-center justify-center z-[-1] bg-[url('https://i0.wp.com/swadishta.de/wp-content/uploads/2021/01/Idle.jpg?fit=1200%2C800&ssl=1')] h-3/5 bg-center bg-cover">
        <form className="h-10 flex justify-center w-64">
          <input 
            type="text" 
            className="shadow-md rounded-l-full font-[Poppins] text-gray-800 pl-2" placeholder="Enter an ingredient"
            value={search}
